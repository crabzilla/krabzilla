...
== 2.0 krabzilla-example1-service

=== 2.1.0 For each aggregate

Now our Customer aggregate is hopefully validated and tested. In order to deploy it, we still need to provide :

==== 2.1.1 CustomerFactory
...
=== 2.2.0 For the Example1

==== 2.2.1 EventProjectors
